	...
	public void getVerificarNum() {
		for (int linha = 0; linha < this.getCelula().length; linha++) {
			for (int coluna = 0; coluna < this.getCelula()[linha].length; coluna++) {
				...
				if(this.getCelula()[0][0] == 1 && this.getCelula()[0][1] == 2 && this.getCelula()[0][2] == 3 && this.getCelula()[0][3] == 4 && this.getCelula()[0][4] == 5 &&
					this.getCelula()[1][0] == 6	&& this.getCelula()[1][1] == 7 && this.getCelula()[1][2] == 8 && this.getCelula()[1][3] == 9 && this.getCelula()[1][4] == 10 &&
					this.getCelula()[2][0] == 11 && this.getCelula()[2][1] == 12 && this.getCelula()[2][2] == 13 && this.getCelula()[2][3] == 14 && this.getCelula()[2][4] == 15 &&
					this.getCelula()[3][0] == 16 && this.getCelula()[3][1] == 17 && this.getCelula()[3][2] == 18 && this.getCelula()[3][3] == 19 && this.getCelula()[3][4] == 20 &&
					this.getCelula()[4][0] == 21 && this.getCelula()[4][1] == 22 && this.getCelula()[4][2] == 23 && this.getCelula()[4][3] == 24 && this.getCelula()[4][4] == 0) {
