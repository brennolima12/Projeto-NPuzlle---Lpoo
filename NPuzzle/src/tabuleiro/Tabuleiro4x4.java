	...
	public void getVerificarNum() {
		for (int linha = 0; linha < this.getCelula().length; linha++) {
			for (int coluna = 0; coluna < this.getCelula()[linha].length; coluna++) {
				...
				if (this.getCelula()[0][0] == 1 && this.getCelula()[0][1] == 2 && this.getCelula()[0][2] == 3 && this.getCelula()[0][3] == 4 && this.getCelula()[1][0] == 5 &&    
					this.getCelula()[1][1] == 6 && this.getCelula()[1][2] == 7 &&  this.getCelula()[1][3] == 8 && this.getCelula()[2][0] == 9 && this.getCelula()[2][1] == 10 &&
					this.getCelula()[2][2] == 11 && this.getCelula()[2][3] == 12 && this.getCelula()[3][0] == 13 && this.getCelula()[3][1] == 14 && this.getCelula()[3][2] == 15 &&
